...
function SentimentCalm() {
  return (
    <div
      className="relative shrink-0 size-[18.126px]"
      data-name="sentiment_calm"
    >
      <svg
...
export function Logo({ onClick }: LogoProps) {
  return (
    <div 
      className="relative rounded-[5.57734px] cursor-pointer hover:opacity-80 transition-opacity" 
      onClick={onClick}
      style={{ 
