...
return (
  <>
    {/* 🔙 Back 버튼 – 무조건 최상단에 표시되도록 Fragment 바깥 fixed + z-[9999] */}
    {onBack && (
      <button
        onClick={onBack}
        className="fixed z-[9999] left-4 sm:left-6 lg:left-8 top-4 sm:top-6 lg:top-8 p-2 text-foreground lg:text-white"
      >
